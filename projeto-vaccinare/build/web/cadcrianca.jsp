            ...
            <form action="CriancaController" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input id="mae" name="mae" type="text" placeholder="Digite o nome da mãe" class="form-control" required="" value="" maxlength="100">

                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label class="control-label" for="email">E-mail:</label>  
                            <input id="email" name="email" type="email" aria-describedby="emailHelp"  placeholder="Digite o e-mail" class="form-control" required="" value="" maxlength="100">
                            <small id="emailHelp" class="form-text text-muted">Ex: email@gmail.com</small>
                        </div>
                    
                        <div class="form-group col-md-6">
                            <label class="control-label" for="telefone">Telefone:</label>  
                            <input id="telefone" name="telefone" type="text" aria-describedby="telHelp"  placeholder="Digite o e-mail" class="form-control" required="" value="" maxlength="20">
